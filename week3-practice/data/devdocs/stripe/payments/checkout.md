...
| &nbsp;                 | [STRIPE-HOSTED PAGE](https://docs.stripe.com/payments/accept-a-payment.md?platform=web&ui=stripe-hosted)    | [EMBEDDED FORM](https://docs.stripe.com/payments/accept-a-payment.md?platform=web&ui=embedded-form)  |
| ---------------------- | ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
