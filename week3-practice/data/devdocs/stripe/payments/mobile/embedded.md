...
Scan this QR code with your iOS mobile device to try an interactive App Clip that demonstrates Stripe’s in-app Elements. In the App Clip, you can generate different UI specifications to see which works best for your use case.
