...
| BF      | bf_ifu     | Burkina Faso Tax Identification Number (NumÃ©ro d'Identifiant Fiscal Unique)                             | 12345678A             | Yes                        |
...
| CA      | ca_qst     | Canadian QST number (QuÃ©bec)                                                                            | 1234567890TQ1234      | Yes                        |
| CD      | cd_nif     | Congo (DR) Tax Identification Number (NÃºmero de IdentificaÃ§Ã£o Fiscal)                                   | A0123456M             | No                         |
...
| CM      | cm_niu     | Cameroon Tax Identification Number (NumÃ©ro d'Identifiant fiscal Unique)                                 | M123456789000L        | No                         |
...
| CV      | cv_nif     | Cape Verde Tax Identification Number (NÃºmero de IdentificaÃ§Ã£o Fiscal)                                   | 213456789             | No                         |
...
| GN      | gn_nif     | Guinea Tax Identification Number (NÃºmero de IdentificaÃ§Ã£o Fiscal)                                       | 123456789             | Yes                        |
...
| HU      | hu_tin     | Hungary tax number (adÃ³szÃ¡m)                                                                            | 12345678-1-23         | No                         |
...
| JP      | jp_cn      | Japanese Corporate Number (*HÅjin BangÅ*)                                                               | 1234567891234         | No                         |
| JP      | jp_rn      | Japanese Registered Foreign Businesses' Registration Number (*TÅroku Kokugai JigyÅsha no TÅroku BangÅ*) | 12345                 | No                         |
| JP      | jp_trn     | Japanese Tax Registration Number (*TÅroku BangÅ*)                                                       | T1234567891234        | Yes                        |
...
| MR      | mr_nif     | Mauritania Tax Identification Number (NÃºmero de IdentificaÃ§Ã£o Fiscal)                                   | 12345678              | No                         |
...
| SI      | si_tin     | Slovenia tax number (davÄna Å¡tevilka)                                                                   | 12345678              | No                         |
...
Stripe provides automatic validation to help determine ?‹â€‹if the formatting is correct when you add the ID to our system. You can see the results of the validation in the Dashboard along with other customer information, including details returned from the government databases, and the registered name and address. However, we don?™t continue to validate them over time. ?‹â€‹If automatic validation isn?™t available, you must manually verify these IDs.
...
> To update a tax ID, delete the old ID and create ?‹â€‹another one.
