...
Setting a quantity on a subscription is often described as ?œper-seat licensing?? which has a linear cost increase: 10 uses incurs a cost of 10 times the base price.
