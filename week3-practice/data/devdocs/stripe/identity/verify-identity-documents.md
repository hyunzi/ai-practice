...
EphemeralKeyCreateParams ephemeralKeyParams =
  EphemeralKeyCreateParams.builder()
    ...
    .setStripeVersion("2025-11-17.clover")
    .build();
...
ek_params := &stripe.EphemeralKeyParams{
  StripeVersion: stripe.String("2025-11-17.clover"),
}
...
{
  StripeVersion = "2025-11-17.clover"
};
...
dependencies {
  ...
  implementation("com.stripe:identity:22.4.0")
}
```
...
dependencies {
  ...
  implementation('com.stripe:ml-core-googleplay:22.4.0') // include the Google Play TFLite runtime
}
```
