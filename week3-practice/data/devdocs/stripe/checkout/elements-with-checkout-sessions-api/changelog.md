...
> 
> If you?™re already on the [Basil release](https://docs.stripe.com/changelog/basil.md) of Elements with Checkout Sessions API, this changelog doesn?™t apply to you.
...
const stripe = require('stripe')('<<YOUR_SECRET_KEY>>', {
  apiVersion: '2025-11-17.clover; custom_checkout_beta=v1;',
});
```
...
Stripe.api_version = '2025-11-17.clover; custom_checkout_beta=v1;'
```
...
$stripe = new \Stripe\StripeClient([
  ...
  "stripe_version" => "2025-11-17.clover; custom_checkout_beta=v1;"
]);
```
...
stripe.APIVersion += "2025-11-17.clover; custom_checkout_beta=v1;"
```
