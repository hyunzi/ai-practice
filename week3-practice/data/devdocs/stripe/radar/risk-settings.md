...
When setting up Radar in the Dashboard, the **Edit Risk mode** page of the modal allows you to choose following risk modes that automatically adjust your fraud protection thresholds based on your business needs and tolerance.
...
When you change your Risk mode, the modal displays the impact to fraudulent and legitimate transactions with the following statistics:
