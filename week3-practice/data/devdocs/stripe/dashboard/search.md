...
| `..`     | Within a range of dates or amounts.                  | **amount:50.00??9.99** |
...
To search for an entire phrase, use quotation marks. For example, **?œStripe Shop??* provides matches for that full phrase, but **Stripe Shop** searches the words **Stripe** and **Shop** separately.
